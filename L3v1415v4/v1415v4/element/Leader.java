...
/**
 * Created by bisounours on 1/5/15.
 */
public class Leader extends Personnage {
     ...
     */
    public Leader(String nom, int force, int charisme, int defense, int determination, int vitesse, int vision) {
