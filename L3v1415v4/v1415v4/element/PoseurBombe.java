 ...
 */
public class PoseurBombe extends PoseurObjet{
	 ...
	 * @param nbObjetMAx
	 */
	public PoseurBombe(String nom, int force, int charisme, int defense, int determination, int vitesse, int vision, int nbObjetMAx) {
	...
	public void ajouterBombe(Bombe b)
	{
		ajouterObjet(b);
	}
}
